...
<footer class="mt-[36px] bg-white max-sm:mt-[30px] border-t-4 border-[#d5cfcf]">
    @if ($customization)
        <div class="flex gap-x-[25px] gap-y-[30px] p-[60px] max-1060:flex-wrap max-1060:flex-col-reverse max-sm:px-[15px]">
            <a
            ...
            <div class="flex gap-[15px] items-start px-5 flex-wrap max-1180:gap-[25px] max-1060:justify-between border-l-2">
                <h1 class="font-bold">
                    @lang('Reamulan Lands Inc.')
                </h1>

                <ul class="grid gap-[15px] text-[14px]">
                    <li>@lang('7 ADB Ave, Ortigas Center, pasig, Metro Manila')</li>
                    <li>@lang('sample@gmail.com')</li>
                    <li>@lang('+63 9456677654')</li>
                </ul>
            </div>
            ...
            <div class="flex gap-[15px] items-start px-5 flex-wrap max-1180:gap-[25px] max-1060:justify-between border-l-2">
                ...
                <div class="flex gap-[15px] items-start flex-wrap max-1180:gap-[25px] max-1060:justify-between">
