                ...
                <div class="flex flex-col md:px-6 xl:flex-row gap-11">
                    ...
                    >
                        ...
                        <hgroup class="flex flex-col max-w-80 gap-4 pr-1.5 mr-4">
                            <h4 class="text-xl font-bold leading-5 text-black">@lang('enclaves::app.customers.inquiries.submit-header')</h4>
                            <p class="text-[1.065rem] leading-[1.375rem] font-normal"> @lang('enclaves::app.customers.inquiries.submit-text')</p>
                        </hgroup>

                        <svg class="ml-auto min-w-10" width="39" class="ml-auto" height="27" viewBox="0 0 39 27"
                    ...
                    >
                        ...
                        <hgroup class="flex flex-col max-w-80 gap-4 pr-1.5 mr-4">
                            <h4 class="text-xl font-bold leading-5 text-black">@lang('enclaves::app.customers.inquiries.tickets')</h4>
                            <p class="text-[1.065rem] leading-[1.375rem] font-normal"> @lang('enclaves::app.customers.inquiries.tickets_text')</p>
                        </hgroup>
