                ...
                <div class="relative max-h-[971px]">
                    ...
                    <div
                        ...
                        <a 
                            ...
                            @click="redirectToProduct(firstProjectURL)"
                        >
                        ...
                        <div class="grid gap-2.5 content-start">
                            ...
                            <div class="flex items-center gap-5 justify-between max-425:flex-wrap">
                                ...
                                <button
                                    ...
                                    @click="redirectToProduct(secoundProjectURL)"
                                >
                                    @lang('enclaves::app.homepage.most-view.choose-area')
                                </button>
                            </div>
                    ...
                    <div class="grid gap-2.5 relative max-w-[350px] max-h-[434px] max-sm:max-h-max">
                        ...
                        <div class="grid gap-2.5 content-start">
                            ...
                            <div class="flex items-center gap-5 justify-between max-425:flex-wrap">
                                ...
                                <button
                                    class="text-white text-nowrap px-[25px] py-[10px] bg-[linear-gradient(268.1deg,_#CC035C_7.47%,_#FCB115_98.92%)] rounded-[20px]"
                                    @click="redirectToProduct(thirdProjectURL)"
                                >
                                    @lang('enclaves::app.homepage.most-view.choose-area')
                                </button>
                            </div>
        ...
        app.component('v-products-most-view', {
            ...
            data() {
                return {
                    ...
                    firstProjectURL: null,

                    secoundProjectURL: null,

                    thirdProjectURL: null,
                };
            },
            ...
            mounted() {
                this.$axios.get('{{ route("enclaves.product.most-view.index") }}')
                    .then(response => {
                        ...
                        this.firstProjectURL = this.firstMostViewProduct.url_key;

                        this.secoundProjectURL = this.secoundMostViewProduct.url_key;

                        this.thirdProjectURL = this.thirdMostViewProduct.url_key;
                    }).catch(error => {
                    });
            },
