<div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
    <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
        @lang('enclaves::app.admin.settings.channels.create.footer-logo')
    </p>
    ...
    <div class="flex justify-between">
        ...
        <div class="flex w-2/5 flex-col">
            ...
            <p class="text-xs text-gray-600 dark:text-gray-300">
                @lang('enclaves::app.admin.settings.channels.create.footer-size')
            </p>
        </div>
    </div>
</div>
            ...
            <form @submit="handleSubmit($event, updateOrCreate)">
                <div class="flex justify-between">
                    <p class="flex items-center text-base font-semibold text-gray-800 dark:text-white">
                        @lang('enclaves::app.admin.settings.channels.create.footer-logo-image')
                    </p>

                    <button class="primary-button" v-if="! isLoading">
                        @lang('enclaves::app.admin.settings.channels.create.preview')
                    </button>

                    <button class="secondary-button" disabled v-else>
                        @lang('enclaves::app.admin.settings.channels.create.loading')
                    </button>
                </div>
                ...
                <x-admin::form.control-group>
                    <x-admin::form.control-group.label>
                        @lang('enclaves::app.admin.settings.channels.create.type')
                    </x-admin::form.control-group.label>
                    ...
                    <x-admin::form.control-group.control
                        ...
                        rules="required"
                        :value="old('type')"
                        :label="trans('enclaves::app.admin.settings.channels.create.type')"
                    >
                        <!-- Default Option -->
                        <option value="" disabled>
                            @lang('enclaves::app.admin.settings.channels.create.select-type')
                        </option>
                        <!-- Default Option -->
                ...
                <x-admin::form.control-group>
                    <x-admin::form.control-group.label>
                        @lang('enclaves::app.admin.settings.channels.create.cdn-link')
                    </x-admin::form.control-group.label>
                    ...
                    <x-admin::form.control-group.control
                        ...
                        rules="required"
                        :value="old('link')"
                        :label="trans('enclaves::app.admin.settings.channels.create.cdn-link')"
                    >
                    </x-admin::form.control-group.control>
