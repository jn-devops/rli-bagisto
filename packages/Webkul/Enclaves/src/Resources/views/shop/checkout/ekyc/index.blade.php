        ...
        <div class="container">
            <div class="m-[20px] p-[20px]" v-if="! sended && ! embedURL">
                ...
                <div 
                    ...
                    <svg 
                        aria-hidden="true" 
                        class="h-8 w-8 animate-spin fill-gray-600 text-gray-200 dark:fill-gray-300 dark:text-gray-600" 
                        viewBox="0 0 100 101" 
                        fill="none" 
                    ...
                    <span class="absolute -left-[80px] text-nowrap" v-text="loadingText"></span>
                </div>
