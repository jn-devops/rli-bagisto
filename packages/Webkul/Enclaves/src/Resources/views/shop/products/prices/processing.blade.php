...
@else
    <p class="processing_fee_text text-nowrap text-[25px] font-bold max-sm:text-[22px]" style="display:none;">@lang('enclaves::app.shop.product.reservation-fee')</p>

    <p class="processing_fee text-[40px] font-bold text-[#CC035C] max-sm:text-[40px]"></p>
@endif
