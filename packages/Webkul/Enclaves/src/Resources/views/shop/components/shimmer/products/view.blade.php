<div class="mt-12 flex gap-2 max-lg:mt-0 max-lg:gap-y-6 max-md:flex-wrap lg:gap-[54px]">
    <div class="min-w-[58%] max-md:w-full">
        ...
        <h1 class="shimmer mb-[26px] mt-[10px] h-[40px] w-[50%]"></h1>
    ...
    <div class="top-12 hidden h-fit w-full flex-col rounded-[20px] px-[38px] py-[46px] shadow-[0px_4px_40px_0px_rgba(220,_228,_240,_1)] max-sm:p-[25px] md:flex">
        <div class="flex flex-wrap">
            ...
            <p class="shimmer mt-[30px] h-[60px] w-[90%]"></p>

            <p class="shimmer mt-[30px] h-[30px] w-[90%]"></p>
            <p class="shimmer mt-[30px] h-[30px] w-[90%]"></p>
            <p class="shimmer mt-[30px] h-[30px] w-[90%]"></p>
            <p class="shimmer mt-[30px] h-[30px] w-[90%]"></p>
        </div>

        <div class="mt-[25px] grid gap-[10px] max-lg:my-[20px] max-lg:flex max-lg:justify-between">
            <p class="shimmer h-[27px] w-[100%] max-lg:h-[21px] max-lg:w-[100px]"></p>
            <p class="shimmer h-[27px] w-[90%] max-lg:hidden"></p>
            <p class="shimmer h-[27px] w-[80%] max-lg:h-[21px] max-lg:w-[60px]"></p>
        </div>

        <!-- Buy Now Button -->
        <button class="shimmer mt-[20px] h-[56px] w-full rounded-[12px]"></button>
    </div>
</div>