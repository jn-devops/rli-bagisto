...
>
    ...
    @isset($header)
        <template v-slot:header="{ toggle, isOpen }">
            <div {{ $header->attributes->merge(['class' => 'flex items-center justify-between gap-5 bg-white p-4 px-9']) }}>
                {{ $header }}
...
@pushOnce('scripts')
    <script
        ...
        id="v-modal-story-details-template"
    >
        <div>
            <div @click="toggle">
                <slot name="toggle">
            ...
            >
                ...
                >
                    <div class="flex min-h-full items-end justify-center p-4 sm:items-center sm:p-0">
                        <div class="absolute left-1/2 top-1/2 z-[999] w-full max-w-[995px] -translate-x-1/2 -translate-y-1/2 overflow-hidden bg-zinc-100 max-md:w-[90%] rounded-[57px] bg-white">
                            <!-- Header Slot-->
                            <slot
                                name="header"
                                :toggle="toggle"
    ...
    <script type="module">
        app.component('v-modal-story-details', {
            template: '#v-modal-story-details-template',
