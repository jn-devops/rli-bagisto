...
@for ($i = 0;  $i < $attributeCount; $i++)
    <div class="flex items-center max-w-full border-b-[1px] border-[#E9E9E9] max-lg:border-0">
        ...
        <div class="flex gap-[12px] border-l-[1px] border-[#E9E9E9] max-lg:border-0">
            @for ($j = 0;  $j < $productCount; $j++)
                <div class="w-[311px] max-w-[311px] pr-0 p-[20px] max-lg:pl-0">
                    <div class="grid gap-[5px]">
                        <p class="shimmer hidden w-[55%] h-[21px] max-lg:block"></p>
                        <p class="shimmer w-[55%] h-[21px]"></p>
                    </div>
                </div>
            @endfor
