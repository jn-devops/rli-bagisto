            ...
            'orders' => [
                ...
                'view' => [
                    ...
                    'information' => [
                        ...
                        'placed-on'             => 'Placed On',
                        'product-name'          => 'Name',
                        'product-property-code' => 'Property-code',
                        'price'                 => 'Price',
                        'sku'                   => 'SKU',
                        'subtotal'              => 'Subtotal',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'subscribe-stay-touch'   => "By clicking Submit. you are aware of and agree to the user rights in processing personal data as outlined in Enclaveswfx's <a href='#' class='font-bold'>Privacy Policy</a> and <a href='#' class='font-bold'>Terms of Use.</a>",
