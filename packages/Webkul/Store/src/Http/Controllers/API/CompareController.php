...
class CompareController extends APIController
{
    ...
    public function store()
    {
        ...
        if ($compareProduct) {
            return (new JsonResource([
                'message' => trans('store::app.compare.already-added'),
        ...
        return new JsonResource([
            'message' => trans('store::app.compare.item-add-success'),
        ]);
    }
    ...
    public function destroy(): JsonResource
    {
        ...
        if (! $success) {
            return new JsonResource([
                'message'  => trans('store::app.compare.remove-error'),
            ]);
        }
        ...
        return new JsonResource([
            ...
            'message' => trans('store::app.compare.remove-success'),
        ]);
    }
    ...
    public function destroyAll(): JsonResource
    {
        ...
        return new JsonResource([
            'message'  => trans('store::app.compare.remove-all-success'),
        ]);
    }
}
