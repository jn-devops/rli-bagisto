...
class CustomerController extends Controller
{
    ...
    public function index()
    {
         ...
         */
        return view('store::customers.account.custom-profile.index', compact('customer'));
    }
    ...
    public function coBorrower()
    {
        ...
        return view('store::customers.account.custom-profile.co-borrower.index', compact('customer'));
    }
}
